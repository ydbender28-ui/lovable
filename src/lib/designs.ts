...
const CATEGORIES = [
  ...
  { id: 'medical_spa', keywords: ['med spa','medspa','medical spa','cosmetic surgery','plastic surgeon','plastic surgery','botox','filler'], industry: 'beauty', heroQuery: 'luxury medical spa clinic modern interior', cardQuery: 'medical spa treatment close up' },
  ...
  { id: 'makeup', keywords: ['makeup','cosmetics','beauty artist','mua','makeup studio','makeup artist','lash','lashes','brow','microblading','tanning','spray tan','tanning salon'], industry: 'beauty', heroQuery: 'makeup artist studio professional', cardQuery: 'makeup application close up' },
  ...
  { id: 'therapy', keywords: ['therapy','therapist','counseling','mental health','psychologist','psychiatrist','life coach','life coaching'], industry: 'medical', heroQuery: 'therapy office calming interior', cardQuery: 'counseling session peaceful' },
  ...
  { id: 'recruiting', keywords: ['recruiting','staffing','hiring','jobs','career','employment','hr','headhunter','talent agency','recruiter'], industry: 'professional', heroQuery: 'modern office hiring interview', cardQuery: 'professional job interview' },
  ...
  { id: 'moving', keywords: ['moving','movers','relocation','packing','hauling','moving company'], industry: 'trades', heroQuery: 'professional movers carrying boxes', cardQuery: 'moving truck loading' },
  { id: 'storage', keywords: ['storage','self storage','storage unit','storage facility'], industry: 'trades', heroQuery: 'clean self storage facility units', cardQuery: 'storage unit interior organized' },
  { id: 'home_inspection', keywords: ['home inspection','inspector','property inspection','building inspection'], industry: 'trades', heroQuery: 'home inspector professional exterior', cardQuery: 'home inspection checklist' },
  { id: 'pool', keywords: ['pool service','pool cleaning','pool maintenance','pool company'], industry: 'trades', heroQuery: 'beautiful backyard swimming pool blue water', cardQuery: 'pool cleaning service' },
  ...
  { id: 'auto_repair', keywords: ['auto repair','mechanic','car repair','auto body','tire','oil change','brake','auto shop'], industry: 'trades', heroQuery: 'auto repair shop garage', cardQuery: 'mechanic working on car' },

  // Tech & Digital
  { id: 'saas', keywords: ['saas','software','platform','app','startup','tech company','crm','customer relationship','project management','task management','productivity app','ecommerce platform','shopify app','woocommerce'], industry: 'tech', heroQuery: 'modern tech office workspace', cardQuery: 'software dashboard screen' },
  { id: 'ai_saas', keywords: ['ai tool','ai platform','machine learning','artificial intelligence','ai startup','llm','generative ai'], industry: 'tech', heroQuery: 'ai technology neural network futuristic', cardQuery: 'ai interface dashboard screen' },
  { id: 'fintech', keywords: ['fintech','payment','billing software','payment processing','neobank','digital bank','crypto'], industry: 'tech', heroQuery: 'fintech modern finance app interface', cardQuery: 'financial app dashboard' },
  { id: 'healthtech', keywords: ['healthtech','healthcare tech','ehr','emr','health software','telehealth','telemedicine'], industry: 'tech', heroQuery: 'healthcare technology digital health platform', cardQuery: 'healthcare app interface' },
  ...
  { id: 'pet_store', keywords: ['pet store','pet shop','pet supplies','dog food','cat food'], industry: 'pet', heroQuery: 'pet store colorful interior', cardQuery: 'cute pet animal' },
  { id: 'pet_grooming', keywords: ['dog grooming','pet grooming','groomer','dog groomer','mobile grooming'], industry: 'pet', heroQuery: 'pet grooming salon colorful friendly', cardQuery: 'dog being groomed salon' },
  { id: 'pet_training', keywords: ['dog training','dog trainer','pet training','obedience training','puppy training'], industry: 'pet', heroQuery: 'dog trainer outdoor training session', cardQuery: 'dog training command obedience' },
  { id: 'pet_care', keywords: ['dog walking','pet sitting','pet care','dog sitter','pet boarding','doggy daycare'], industry: 'pet', heroQuery: 'dog walker happy dogs park', cardQuery: 'pet sitter with dogs outdoor' },
  ...
  // Automotive
  { id: 'car_dealer', keywords: ['car dealer','dealership','auto sales','used cars','new cars','vehicle','car dealership','auto dealer'], industry: 'automotive', heroQuery: 'car dealership showroom luxury', cardQuery: 'luxury car showroom' },
