...
const CATEGORIES = [
  ...
  { id: 'pet_grooming', keywords: ['dog grooming','pet grooming','groomer','dog groomer','mobile grooming'], industry: 'retail', heroQuery: 'pet grooming salon colorful friendly', cardQuery: 'dog being groomed salon' },
  { id: 'pet_training', keywords: ['dog training','dog trainer','pet training','obedience training','puppy training'], industry: 'retail', heroQuery: 'dog trainer outdoor training session', cardQuery: 'dog training command obedience' },
  { id: 'pet_care', keywords: ['dog walking','pet sitting','pet care','dog sitter','pet boarding','doggy daycare'], industry: 'retail', heroQuery: 'dog walker happy dogs park', cardQuery: 'pet sitter with dogs outdoor' },
