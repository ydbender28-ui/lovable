        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4 pt-2">
            {[
              ...
              <div key={f} className="flex items-center gap-3 text-sm" style={{ color: "#51515c" }}>
                <span
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-6 text-center text-sm" style={{ color: "#71717f" }}>
            No account?{" "}
            <Link href="/signup" className="font-medium transition-opacity hover:opacity-80" style={{ color: "#6a1ff7" }}>
              Sign up free
            </Link>
          </p>
        </div>
